...
@trunk_line:        #000000;//#E68A5C;
@trunk_fill:        #FFFFFF;//lighten(@trunk_line,10%);
@trunk_case:        @trunk_line * 0.9;

@primary_line:      #000000;//#FFC859;
@primary_fill:      #FFFFFF;//lighten(@primary_line,10%);
@primary_case:      @primary_line * 0.9;

@secondary_line:    #000000;//#FFE873;
@secondary_fill:    #FFFFFF;//lighten(@secondary_line,10%);
